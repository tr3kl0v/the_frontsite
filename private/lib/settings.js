...
var debug = require('debuglog')('FrontSide/settings');
...
module.exports = function settings(app, options) {
    ...
    function mount(app, options, config) {
        ...
        if (options.inheritViews) {
            ...
            // frontside settings so the app settings aren't updated later.
        ...
        // from the parent app. Any remaining frontside config will be set
    ...
    function complete(config) {
        ...
        if (options.inheritViews) {
            // Update frontside config to reflect express settings
            ...
            // values are available to update frontside config as
            // appropriate.
